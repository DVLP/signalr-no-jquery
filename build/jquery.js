...
(function (window, undefined) {
    ...
    jQuery.extend({
        ...
        data: function data(elem, name, _data, pvt /* Internal Use Only */) {
            ...
            if ((!id || pvt && id && cache[id] && !cache[id][internalKey]) && getByName && _data === undefined) {
                return;
            }
    ...
    jQuery.event = {
        ...
        add: function add(elem, types, handler, data) {
            ...
            if (!_eventHandle) {
                elemData.handle = _eventHandle = function eventHandle(e) {
                    ...
                    return typeof jQuery !== "undefined" && (!e || jQuery.event.triggered !== e.type) ? jQuery.event.handle.apply(_eventHandle.elem, arguments) : undefined;
                };
            }
        ...
        remove: function remove(elem, types, handler, pos) {
    ...
    var withinElement = function withinElement(event) {
        ...
        jQuery.fn[name] = function (type, data, fn) {
            ...
            if (name === "one") {
                _handler = function handler(event) {
                    jQuery(this).unbind(event, _handler);
                    return fn.apply(this, arguments);
                };
                _handler.guid = fn.guid || jQuery.guid++;
            } else {
                _handler = fn;
            }
            ...
            if (type === "unload" && name !== "one") {
                ...
                for (var i = 0, l = this.length; i < l; i++) {
                    jQuery.event.add(this[i], type, _handler, data);
                }
            }
    ...
    jQuery.fn.extend({
        unbind: function unbind(type, fn) {
            // Handle object literals
            if ((typeof type === "undefined" ? "undefined" : _typeof(type)) === "object" && !type.preventDefault) {
                for (var key in type) {
    ...
    jQuery.each(["live", "die"], function (i, name) {
        jQuery.fn[name] = function (types, data, fn, origSelector /* Internal Use Only */) {
            ...
            if ((typeof types === "undefined" ? "undefined" : _typeof(types)) === "object" && !types.preventDefault) {
    ...
    (function () {
            ...
            filter: {
                PSEUDO: function PSEUDO(elem, match, i, array) {
                    ...
                    if (filter) {
                        ...
                        return (elem.textContent || elem.innerText || _Sizzle2.getText([elem]) || "").indexOf(match[3]) >= 0;
                    } else if (name === "not") {
                        var not = match[3];
        ...
        _Sizzle2.getText = function (elems) {
            var ret = "",
                elem;
            ...
            for (var i = 0; elems[i]; i++) {
                ...
                if (elem.nodeType === 3 || elem.nodeType === 4) {
                    ...
                    ret += _Sizzle2.getText(elem.childNodes);
                }
            }
        ...
        var posProcess = function posProcess(selector, context) {
            ...
            for (var i = 0, l = root.length; i < l; i++) {
                _Sizzle2(selector, root[i], tmpSet);
            }
    ...
    jQuery.fn.extend({
        ...
        stop: function stop(clearQueue, gotoEnd) {
            if (clearQueue) {
                this.queue([]);
            }
